...
출력변수(y) : 10진 정수
'''
dir(digits) # 'data','feature_names', 'frame', 'images', 'target', 'target_names']
...
X_2d.shape # (1797, 64) -> (1797, 8, 8) : (size, h, w)

X_2d[0] # 첫번째 이미지 
X_2d[-1] # 마지막 이미지 

plt.imshow(X=X_2d[-1], cmap='gray') # 흑백출력 
plt.show()
y[-1] #  8
