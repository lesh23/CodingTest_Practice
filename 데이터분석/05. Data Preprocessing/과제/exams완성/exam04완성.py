...
new_df = boston.drop(labels='CAT. MEDV', axis=1)
new_df.shape # (506, 14) : 1개 변수 제거 

# 단계3 : new_df에서 1~13칼럼으로 X변수 만들기   
X = new_df.iloc[:,:13]

# 단계4 : new_df에서 'MEDV' 칼럼으로 y변수 만들기 
y = new_df['MEDV'] # 1개 변수 선택 

# 단계5 : X변수와 y변수 요약통계량 확인하기   
X.describe() # 각변수 마다 척도(scale) 다름 
y.describe() # 5~50
...
new_df2.describe() # X변수 : mean=0, std=1
'''
               CRIM            ZN  ...         LSTAT        MEDV
...
'''
new_df2['MEDV'].describe() # y변수 : 1.79 ~ 3.93
