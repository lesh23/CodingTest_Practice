...
# 1) 파생변수 추가 
df['grade'] = grade # 성적(등급) 
df['Alcohol'] = Alcohol # 알콜 소비량 
...
'''
 ...
 6   Alcohol   395 non-null    float64 : 연속형(100~500) : y
'''
...
M    16.657754  0.368984  4.000000  33.219251  219.786096
'''
...
# 각 연령대별 알콜 소비량 평균으로 시각화 
sn.barplot(x='age', y='Alcohol', data=new_df)

# 2) Alcohol vs grade  
sn.scatterplot(x="grade", y="Alcohol", data=new_df) 

# 각 성적대별 알콜 소비량 평균으로 시각화
sn.barplot(x='grade', y='Alcohol', 
           data=new_df, errwidth=0)
